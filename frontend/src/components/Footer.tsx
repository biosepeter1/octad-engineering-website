        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Octad Engineering</span>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+2348031234567" className="text-gray-300 hover:text-primary transition-colors">+234 803 123 4567</a>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="mailto:info@octadengineering.com" className="text-gray-300 hover:text-primary transition-colors">info@octadengineering.com</a>
              </div>

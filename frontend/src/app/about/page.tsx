  ...
  values: [
    {
      ...
      description: 'We start by understanding your vision — what you hope to create, feel, and achieve. We believe design should begin with empathy.'
    },
    {

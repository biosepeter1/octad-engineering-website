        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Octad Engineering Admin</h1>
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 text-white shadow-xl">
            <div className="flex items-center justify-between">
              <div className="animate-pulse">
                ...
                <p className="text-white/90 text-lg">Manage your construction projects and customer messages</p>
              </div>
              <div className="hidden md:block animate-bounce">
                <BuildingStorefrontIcon className="w-20 h-20 text-white/20" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 sm:px-0 mb-8">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            {/* Projects Stats */}
            <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600 group-hover:text-blue-700 transition-colors">{stats.projects}</p>
            ...
            <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-emerald-600 group-hover:text-emerald-700 transition-colors">{stats.contacts}</p>
            ...
            <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="p-3 bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow-lg animate-pulse">
                      <EnvelopeIcon className="w-6 h-6 text-white" />
                    </div>
                    <h3 className="text-lg font-semibold text-gray-900">Unread</h3>
                  </div>
                  <p className="text-3xl font-bold text-red-600 group-hover:text-red-700 transition-colors">{stats.unreadContacts}</p>
        ...
        <div className="px-4 sm:px-0">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
            ...
            <div className="ml-3 w-6 h-0.5 bg-gradient-to-r from-primary to-secondary rounded-full"></div>
          </h2>
              ...
              >
                ...
                <div className="relative p-8">
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      <div className={`p-4 ${item.bgColor} rounded-xl shadow-lg ${item.shadowColor} group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <div className="flex items-center space-x-3">
                      {item.count !== null && (
                        <span className="bg-gray-100 group-hover:bg-white/20 text-gray-800 group-hover:text-white px-3 py-1 rounded-full text-sm font-semibold transition-all duration-300">
                          {item.count}
                        </span>
                      )}
                      {item.badge && (
                        <span className="bg-red-100 group-hover:bg-red-500 text-red-800 group-hover:text-white px-3 py-1 rounded-full text-sm font-semibold animate-pulse transition-all duration-300">
                          {item.badge} new
                        </span>
                      )}
                      <ArrowUpRightIcon className="w-6 h-6 text-gray-400 group-hover:text-white transition-all duration-300 transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                    </div>
                  </div>
                  
                  {/* Action Buttons */}
                  <div className="flex space-x-3">
                    <div className="flex-1 bg-gray-50 group-hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                      <div className="flex items-center justify-between">
                        ...
                        <EyeIcon className="w-4 h-4 text-gray-500 group-hover:text-white transition-colors" />
                      </div>
                    </div>
                    
                    <div className="bg-gray-50 group-hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                      <PlusIcon className="w-5 h-5 text-gray-500 group-hover:text-white transition-colors" />
                    </div>
                  </div>
                </div>
        ...
        <div className="px-4 sm:px-0 mt-12">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Need to view the public website?</h3>
                <p className="text-gray-600 text-sm">Check how your content looks to visitors</p>
              </div>
              <Link
                href="/"
                target="_blank"
                className="group inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary to-secondary text-white font-semibold rounded-lg hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
              >
                <span>View Website</span>
                <ArrowUpRightIcon className="ml-2 w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
              </Link>
            </div>
          </div>
        </div>

            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
                />
              </div>
              ...
              <div className="flex flex-col xs:flex-row gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <select
                    ...
                    className="w-full px-2 sm:px-3 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
                  >
          ...
          <div className="container-custom">
            {filteredProjects.length === 0 ? (
              <div className="text-center py-12 sm:py-16">
                <BuildingStorefrontIcon className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 text-gray-300 mx-auto mb-4 sm:mb-6" />
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-600 mb-3 sm:mb-4">No Projects Found</h3>
                    ...
                    return (
                      <div key={project._id} className="bg-white rounded-lg shadow-lg overflow-hidden group hover:shadow-construction transition-shadow">
                        ...
                        <div className="relative h-48 sm:h-56 lg:h-64 bg-gray-200 overflow-hidden">
                          {primaryImage ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-gray-200">
                              <BuildingStorefrontIcon className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400" />
                            </div>
                          )}
                          
                          {/* Status Badge */}
                          <div className="absolute top-2 left-2 sm:top-4 sm:left-4">
                            <span className={`px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-medium capitalize ${statusColors[project.status] || 'bg-gray-100 text-gray-800'}`}>
                          ...
                          {project.isFeature && (
                            <div className="absolute top-2 right-2 sm:top-4 sm:right-4">
                              <span className="px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-medium bg-secondary text-white">
                                Featured
                              </span>
                            </div>
                          )}
                        ...
                        <div className="p-4 sm:p-6">
                          {/* Category */}
                          <div className="text-xs sm:text-sm text-secondary font-medium mb-1 sm:mb-2">
                            {project.category}
                          </div>
                          ...
                          <button 
                            ...
                            className="w-full btn-outline text-xs sm:text-sm py-2 sm:py-3 group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all"
                          >
                            <EyeIcon className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2 inline" />
                            View Details
                          </button>
                        </div>
                      </div>
                ...
                {pagination.pages > 1 && (
                  <div className="flex justify-center items-center mt-8 sm:mt-12 space-x-1 sm:space-x-2">
                    <button
                      ...
                      className="p-2 sm:p-3 rounded-lg border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50"
                    >
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 animate-fade-in" style={{animationDelay: '300ms'}}>
              <div className="text-center">
                <div className="text-3xl xs:text-4xl sm:text-4xl font-bold text-primary mb-1 sm:mb-2">
                  <AnimatedCounter 
                    end={projects.length} 
                    suffix="+" 
                    duration={2000}
                ...
                <p className="text-sm sm:text-base text-gray-600">Total Projects</p>
              </div>
              <div className="text-center">
                <div className="text-3xl xs:text-4xl sm:text-4xl font-bold text-secondary mb-1 sm:mb-2">
                  <AnimatedCounter 
                ...
                <p className="text-sm sm:text-base text-gray-600">Completed</p>
              </div>
              <div className="text-center">
                <div className="text-3xl xs:text-4xl sm:text-4xl font-bold text-accent mb-1 sm:mb-2">
                  <AnimatedCounter 
                ...
                <p className="text-sm sm:text-base text-gray-600">In Progress</p>
              </div>
              <div className="text-center">
                <div className="text-3xl xs:text-4xl sm:text-4xl font-bold text-gray-600 mb-1 sm:mb-2">
                  <AnimatedCounter 
